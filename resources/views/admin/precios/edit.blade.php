            ...
            <div class="col-md main1">
                ...
                <div class="col-lg-12 col-md-12 col-panel2 col-xl-12">
                        <div class="row row-panel2">
                            ...
                            <div class="col-lg-12 col-md-12 col-panel1 col-xl-12">
                                <form action="{{route('precios.update', $precios->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-row">
                                        <div class="col-lg-4 col-md-4 col-xl-4 mb-3">
                                            ...
                                            <input type="number" name="price" class="form-control" id="validationDefault01" value="{{$precios->precio}}"  required=""/>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-xl-4 mb-3">
                                            <label for="validationDefault01">Descripción:</label>
                                            <input type="text" name="description" class="form-control" id="validationDefault01" value="{{$precios->description}}"  required=""/>
                                        </div>
                                       
                                    </div>

                                    
                                    <button class="btn btn-primary btn-send mt-3" type="submit">Actualizar Precio</button>
                                </form>                                 
                            </div>
                        </div>
